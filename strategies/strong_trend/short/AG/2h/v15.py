"""StrongTrendShortAG2hV15 — KAMA(40) slope neg + MFI(12) < 38.

Economic logic: KAMA(40) adapts to 2H silver's volatility regime. Negative slope
confirms sustained downward direction. MFI(12) below 38 validates that money is
flowing out — institutional selling pressure without matching buy-side support.
"""
...
class StrongTrendShortAG2hV15(TrendingStrategy):
    """KAMA(40) slope < 0 + MFI(12) < 38."""

    name = "strong_trend_short_AG_2h_v15"
    horizon = "medium"
    direction = "short"
