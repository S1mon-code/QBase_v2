"""StrongTrendShortAGDailyV19 — Donchian(45) lower break + ADX(22) > 22.

Economic logic: Price breaking through the Donchian(45) lower channel signals
a new 45-day low — a powerful bearish breakout. ADX(22) above 22 confirms the
breakout has genuine trend strength, filtering out false breakdowns in low-
volatility consolidation periods.
"""
...
class StrongTrendShortAGDailyV19(TrendingStrategy):
    """Donchian(45) lower break + ADX(22) > 22."""

    name = "strong_trend_short_AG_daily_v19"
    horizon = "slow"
    direction = "short"
    ...
    def get_indicator_config(self):
        return [
            ...
            {"name": f"ADX({self.adx_period})", "array": self._adx_line,
             "panel": "ADX", "y_range": [0, 100], "horizontal_lines": [22]},
        ]
