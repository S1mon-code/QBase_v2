"""StrongTrendShortAGDailyV13 — MACD(16,36,10) bearish + Klinger(20,40) < 0.

Economic logic: MACD line below signal line on daily silver confirms bearish
momentum. Klinger Volume Oscillator turning negative validates that volume-
weighted money flow supports the downtrend — sellers are dominating accumulation.
"""
...
class StrongTrendShortAGDailyV13(TrendingStrategy):
    """MACD(16,36,10) bearish + Klinger(20,40) < 0."""

    name = "strong_trend_short_AG_daily_v13"
    horizon = "slow"
    direction = "short"
    ...
    def on_init_arrays(self, closes, highs, lows, opens, volumes, oi, datetimes):
        ...
        self._klinger_line, _ = klinger(
            ...
            fast=self.klinger_fast, slow=40,
        )
