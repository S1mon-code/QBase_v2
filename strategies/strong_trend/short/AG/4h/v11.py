"""StrongTrendShortAG4hV11 — EMA(22,55) bearish + RSI(14) < 44 + OBV declining.

Economic logic: EMA(22) below EMA(55) on 4H silver confirms a multi-session
downtrend. RSI(14) below 44 validates weakening buying pressure. OBV below
its SMA confirms distribution — volume is consistently flowing out during
the bearish phase.
"""
...
class StrongTrendShortAG4hV11(TrendingStrategy):
    """EMA(22) < EMA(55) + RSI(14) < 44 + OBV < SMA(35)."""

    name = "strong_trend_short_AG_4h_v11"
    horizon = "medium"
    direction = "short"
