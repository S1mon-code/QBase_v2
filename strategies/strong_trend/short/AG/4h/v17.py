"""StrongTrendShortAG4hV17 — Vortex(18) VI- > VI+ + ROC(16) < 0.

Economic logic: Vortex(18) on 4H silver measures directional movement at a
balanced pace. VI- dominating VI+ confirms bearish directional momentum.
ROC(16) negative validates that the rate of price decline persists over the
lookback — not just a momentary dip.
"""
...
class StrongTrendShortAG4hV17(TrendingStrategy):
    """Vortex(18) VI- > VI+ + ROC(16) < 0."""

    name = "strong_trend_short_AG_4h_v17"
    horizon = "medium"
    direction = "short"
    signal_dimensions = ["momentum"]
    warmup: int = 25

    vortex_period: int = 18
    roc_period: int = 16
