"""StrongTrendShortAG4hV14 — Bollinger(22,2.0) below middle + CMF(20) < 0.

Economic logic: Price below the Bollinger(22) middle band on 4H silver signals
bearish bias at the intermediate timeframe. CMF(20) negative confirms persistent
distribution — selling volume consistently exceeds buying. The combination
filters out brief dips that lack volume confirmation.
"""
...
class StrongTrendShortAG4hV14(TrendingStrategy):
    """Bollinger(22,2.0) price < middle + CMF(20) < 0."""

    name = "strong_trend_short_AG_4h_v14"
    horizon = "medium"
    direction = "short"
