"""MildTrendLongIDailyV49 — ROC(25) > 0 + SuperTrend(16,3.0) bullish + CMF(20) > 0.

Economic logic: Rate of Change captures momentum over a medium window — positive ROC
means price is higher than 25 bars ago. SuperTrend provides adaptive trend-following
with built-in volatility adjustment. CMF validates institutional money flow direction.
"""
...
class MildTrendLongIDailyV49(TrendingStrategy):
    name = "mild_trend_long_I_daily_v49"
    horizon = "medium"
    direction = "long"
    ...
    def _generate_signal(self, bar_index: int) -> float:
        ...
        # Scale by ROC magnitude (0-10% mapped to 0.3-0.8)
