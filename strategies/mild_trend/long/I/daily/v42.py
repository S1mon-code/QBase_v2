"""MildTrendLongIDailyV42 — Fisher Transform(20) bullish cross + OBV above SMA(50).

Economic logic: Fisher Transform converts price into a Gaussian distribution, making
turning points sharper and easier to detect. A bullish cross (Fisher crossing above
its trigger) signals momentum shift. OBV above its SMA confirms volume-backed buying.
"""
...
class MildTrendLongIDailyV42(TrendingStrategy):
    name = "mild_trend_long_I_daily_v42"
    horizon = "medium"
    direction = "long"
    ...
    def _generate_signal(self, bar_index: int) -> float:
        ...
        # Bullish cross: Fisher crosses above trigger
