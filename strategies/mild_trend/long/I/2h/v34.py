"""MildTrendLongI2hV34 — Bollinger(20) squeeze + MACD(10,24,7) bullish.

Economic logic: Bollinger squeeze on 2h detects volatility compression before
directional moves. MACD with balanced parameters confirms breakout direction.
...
class MildTrendLongI2hV34(TrendingStrategy):
    name = "mild_trend_long_I_2h_v34"
    horizon = "medium"
    direction = "long"
