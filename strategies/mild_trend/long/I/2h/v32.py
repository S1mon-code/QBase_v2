"""MildTrendLongI2hV32 — Fisher Transform(14) bullish + OBV above SMA(30).

Economic logic: Fisher Transform on 2h bars provides balanced turning point detection.
Bullish Fisher cross signals momentum shift. OBV above its SMA confirms accumulation.
...
class MildTrendLongI2hV32(TrendingStrategy):
    name = "mild_trend_long_I_2h_v32"
    horizon = "medium"
    direction = "long"
