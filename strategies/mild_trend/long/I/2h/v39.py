"""MildTrendLongI2hV39 — HMA(40) slope + Stochastic(12,5) > 52.

Economic logic: Hull Moving Average on 2h provides responsive trend detection with
minimal lag. Stochastic above 52 confirms moderate bullish momentum. Signal scales
with HMA slope magnitude and stochastic level.
"""
...
class MildTrendLongI2hV39(TrendingStrategy):
    name = "mild_trend_long_I_2h_v39"
    horizon = "medium"
    direction = "long"
