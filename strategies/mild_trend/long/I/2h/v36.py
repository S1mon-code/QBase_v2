"""MildTrendLongI2hV36 — TSI(12,22) bullish + Klinger(14,28) > 0.

Economic logic: TSI double-smooths momentum on 2h bars for clean trend signals.
Positive Klinger oscillator confirms volume-weighted buying pressure. Dual momentum
and volume validation for high-quality trend entries.
"""
...
class MildTrendLongI2hV36(TrendingStrategy):
    name = "mild_trend_long_I_2h_v36"
    horizon = "medium"
    direction = "long"
