"""MildTrendLongI2hV35 — Donchian(25) upper break + MFI(12) > 55.

Economic logic: Donchian channel breakout on 2h captures medium-term new highs.
MFI above 55 confirms money flow supports the breakout. Dual confirmation for
...
class MildTrendLongI2hV35(TrendingStrategy):
    name = "mild_trend_long_I_2h_v35"
    horizon = "medium"
    direction = "long"
