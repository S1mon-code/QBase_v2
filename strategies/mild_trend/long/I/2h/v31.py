"""MildTrendLongI2hV31 — Schaff Trend(20,14,7) > 25 + CMF(15) > 0.

Economic logic: Schaff Trend Cycle on 2h bars balances responsiveness and noise
filtering. STC above 25 signals emerging uptrend. CMF confirms institutional money
flow direction. Signal scales with STC strength and CMF magnitude.
"""
...
class MildTrendLongI2hV31(TrendingStrategy):
    name = "mild_trend_long_I_2h_v31"
    horizon = "medium"
    direction = "long"
