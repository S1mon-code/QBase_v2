"""MildTrendLongI4hV37 — CCI(20) > 0 + OI momentum(16) > 0.

Economic logic: CCI on 4h captures medium-term price deviations from statistical
mean. OI momentum confirms new long positions. Dual confirmation from price and
open interest positioning for robust 4h entries.
"""
...
class MildTrendLongI4hV37(TrendingStrategy):
    name = "mild_trend_long_I_4h_v37"
    horizon = "medium"
    direction = "long"
