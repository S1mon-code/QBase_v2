"""MildTrendLongI4hV32 — Fisher Transform(16) bullish + OBV above SMA(40).

Economic logic: Fisher Transform on 4h bars provides clean turning point detection.
Bullish Fisher cross with OBV above its SMA confirms volume-backed trend shift.
Signal scales with Fisher spread and is boosted on fresh crosses.
"""
...
class MildTrendLongI4hV32(TrendingStrategy):
    name = "mild_trend_long_I_4h_v32"
    horizon = "medium"
    direction = "long"
    signal_dimensions = ["momentum", "volume"]
    warmup = 60

    fisher_period: int = 16
