"""MildTrendLongI1hV54 — Bollinger(15) squeeze + MACD(8,18,6) bullish.

Economic logic: Bollinger squeeze on 1h bars catches intraday volatility compression
before breakout. MACD with fast parameters confirms the directional bias of the
breakout. Signal scales with MACD spread and bandwidth expansion rate.
"""
...
class MildTrendLongI1hV54(TrendingStrategy):
    name = "mild_trend_long_I_1h_v54"
    horizon = "fast"
    direction = "long"
