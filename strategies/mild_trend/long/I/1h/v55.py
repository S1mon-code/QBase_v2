"""MildTrendLongI1hV55 — Donchian(15) upper break + MFI(8) > 55.

Economic logic: Donchian channel breakout on 1h captures intraday high breaks with
a short lookback. MFI above 55 confirms money flowing in. Dual confirmation reduces
whipsaw common in shorter timeframes.
"""
...
class MildTrendLongI1hV55(TrendingStrategy):
    name = "mild_trend_long_I_1h_v55"
    horizon = "fast"
    direction = "long"
    ...
    def _generate_signal(self, bar_index: int) -> float:
        ...
        # Scale by MFI strength (55-80 mapped to 0.4-1.0)
