"""MildTrendLongI1hV51 — Schaff Trend(15,10,5) > 25 + CMF(10) > 0.

Economic logic: Schaff Trend Cycle adapted for intraday with shorter periods detects
early momentum shifts. CMF confirms institutional money flow on 1h bars. Signal scales
with STC strength and CMF magnitude for position sizing.
"""
...
class MildTrendLongI1hV51(TrendingStrategy):
    name = "mild_trend_long_I_1h_v51"
    horizon = "fast"
    direction = "long"
