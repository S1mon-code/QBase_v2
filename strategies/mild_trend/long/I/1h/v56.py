"""MildTrendLongI1hV56 — TSI(8,16) bullish + Force Index(6) > 0.

Economic logic: TSI with fast parameters captures intraday momentum shifts while
double-smoothing removes noise. Positive Force Index confirms volume-weighted
buying pressure. Signal scales with TSI magnitude and is boosted when rising.
"""
...
class MildTrendLongI1hV56(TrendingStrategy):
    name = "mild_trend_long_I_1h_v56"
    horizon = "fast"
    direction = "long"
