"""MildTrendLongI1hV57 — CCI(12) > 0 + OI momentum(10) > 0.

Economic logic: CCI on short 1h window detects intraday price deviations from mean.
Positive CCI shows buying pressure. OI momentum confirms new positions opening on the
long side. Dual confirmation of price and positioning signals.
"""
...
class MildTrendLongI1hV57(TrendingStrategy):
    name = "mild_trend_long_I_1h_v57"
    horizon = "fast"
    direction = "long"
