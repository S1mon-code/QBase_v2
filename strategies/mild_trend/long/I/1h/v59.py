"""MildTrendLongI1hV59 — HMA(25) slope + Stochastic(8,3) > 55.

Economic logic: Hull Moving Average with short period provides responsive intraday
trend detection with minimal lag. Stochastic above 55 confirms mid-range bullish
momentum without overbought risk. Signal scales with HMA slope and stochastic level.
"""
...
class MildTrendLongI1hV59(TrendingStrategy):
    name = "mild_trend_long_I_1h_v59"
    horizon = "fast"
    direction = "long"
    ...
    def _generate_signal(self, bar_index: int) -> float:
        ...
        stoch_boost = min(0.2, (sk - 55.0) / 225.0)
