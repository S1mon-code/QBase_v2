"""MildTrendShortI4hV16 — Aroon down dominant + OBV below SMA.

Economic logic: Aroon(25) down > 70 on 4H Iron Ore indicates recent lows
dominate the lookback window. OBV below SMA(45) validates sustained
distribution, showing volume-weighted selling outpacing buying.
"""
...
class MildTrendShortI4hV16(TrendingStrategy):
    """Aroon(25) down > 70 + OBV < SMA(45)."""

    name = "mild_trend_short_I_4h_v16"
    horizon = "medium"
    direction = "short"
