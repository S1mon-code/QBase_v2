"""MildTrendShortI4hV14 — Donchian lower break + ADX trending.

Economic logic: Price breaking below Donchian(40) lower channel on 4H Iron Ore
signals a new medium-term low. ADX(22) > 20 confirms directional movement,
...
class MildTrendShortI4hV14(TrendingStrategy):
    """Donchian(40) lower break + ADX(22) > 20."""

    name = "mild_trend_short_I_4h_v14"
    horizon = "medium"
    direction = "short"
