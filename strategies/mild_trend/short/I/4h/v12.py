"""MildTrendShortI4hV12 — SuperTrend bearish + CMF distribution.

Economic logic: SuperTrend(15,3.2) flipping bearish on 4H Iron Ore signals
a regime shift to downtrend. CMF(22) < 0 confirms institutional distribution,
validating the bearish SuperTrend with volume-based evidence.
"""
...
class MildTrendShortI4hV12(TrendingStrategy):
    """SuperTrend(15,3.2) bearish + CMF(22) < 0."""

    name = "mild_trend_short_I_4h_v12"
    horizon = "medium"
    direction = "short"
