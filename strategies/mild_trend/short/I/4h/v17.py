"""MildTrendShortI4hV17 — Vortex bearish + CCI oversold.

Economic logic: Vortex(20) VI- > VI+ on 4H Iron Ore identifies bearish
rotational momentum. CCI(20) < -50 confirms the instrument is trading below
its statistical mean, reinforcing the short signal.
"""
...
class MildTrendShortI4hV17(TrendingStrategy):
    """Vortex(20) VI- > VI+ + CCI(20) < -50."""

    name = "mild_trend_short_I_4h_v17"
    horizon = "medium"
    direction = "short"
