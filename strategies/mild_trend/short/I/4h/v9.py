"""MildTrendShortI4hV9 — Keltner Lower Break + ROC Negative + Wyckoff Distribution.

Economic logic: Breaking below Keltner lower band on 4H signals volatility-adjusted
weakness. Negative ROC confirms falling prices. Wyckoff bearish divergence
reveals institutional distribution behind the price decline.
"""
...
class MildTrendShortI4hV9(TrendingStrategy):
    """Break Keltner(35,2.0) lower + ROC(25)<0 + Wyckoff distribution."""

    name = "mild_trend_short_I_4h_v9"
    horizon = "medium"
    direction = "short"
    ...
    def on_init_arrays(
        ...
        _, self._bear_wyckoff, _ = wyckoff_divergence(
            self._highs, self._lows, self._closes, self._volumes, self.wyckoff_lb,
        )
    ...
    def _generate_signal(self, bar_index: int) -> float:
        ...
        wyck = self._bear_wyckoff[bar_index]
