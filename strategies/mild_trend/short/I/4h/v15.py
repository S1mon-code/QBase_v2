"""MildTrendShortI4hV15 — KAMA slope negative + MFI weak.

Economic logic: KAMA(60) declining on 4H Iron Ore adapts to market noise and
signals a persistent bearish drift. MFI(16) < 40 confirms money flow is net
...
class MildTrendShortI4hV15(TrendingStrategy):
    """KAMA(60) slope < 0 + MFI(16) < 40."""

    name = "mild_trend_short_I_4h_v15"
    horizon = "slow"
    direction = "short"
    ...
    def _raw_signal(self, bar_index: int) -> float:
        ...
        signal = -(0.3 + min(0.2, slope_pct * 350))
