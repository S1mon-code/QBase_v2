"""MildTrendShortI4hV13 — MACD bearish + Force Index negative.

Economic logic: MACD(15,32,10) line below signal on 4H Iron Ore identifies
medium-slow bearish momentum. Force Index(16) < 0 confirms volume-weighted
...
class MildTrendShortI4hV13(TrendingStrategy):
    """MACD(15,32,10) bearish + Force Index(16) < 0."""

    name = "mild_trend_short_I_4h_v13"
    horizon = "medium"
    direction = "short"
    ...
    def _raw_signal(self, bar_index: int) -> float:
        ...
        macd_gap = abs(ml - ms)
        signal = -(0.3 + min(0.2, macd_gap * 0.6))
