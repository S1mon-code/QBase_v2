"""MildTrendShortI1hV18 — HMA slope negative + Stochastic weak.

Economic logic: HMA(20) declining slope on 1H Iron Ore provides a smooth,
lag-reduced bearish signal. Stochastic(8,3) < 30 confirms the price is
near its recent lows, validating sustained selling pressure.
"""
...
class MildTrendShortI1hV18(TrendingStrategy):
    """HMA(20) slope < 0 + Stochastic(8,3) < 30."""

    name = "mild_trend_short_I_1h_v18"
    horizon = "fast"
    direction = "short"
