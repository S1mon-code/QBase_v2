"""MildTrendShortIDailyV16 — Aroon down dominant + OBV below SMA.

Economic logic: Aroon(30) down > 70 on daily Iron Ore indicates recent lows
are dominating the lookback window, confirming bearish price action. OBV
falling below its SMA(60) validates sustained distribution, showing
volume-weighted selling outpacing buying.
"""
...
class MildTrendShortIDailyV16(TrendingStrategy):
    """Aroon(30) down > 70 + OBV < SMA(60)."""

    name = "mild_trend_short_I_daily_v16"
    horizon = "medium"
    direction = "short"
    ...
    def _raw_signal(self, bar_index: int) -> float:
        ...
        # Base signal from Aroon down dominance
    ...
    def get_indicator_config(self) -> list[dict]:
        return [
            ...
            {"name": f"Aroon Down({self.aroon_period})", "array": self._aroon_down, "type": "subplot",
             "panel": "Aroon", "color": "#ef5350", "horizontal_lines": [self.aroon_threshold]},
