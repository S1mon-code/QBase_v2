"""MildTrendShortI2hV11 — EMA bearish cross + RSI weak + OBV declining.

Economic logic: EMA(20) crossing below EMA(50) on 2H Iron Ore signals a
medium-term bearish momentum shift. RSI(14) < 45 confirms fading buying
...
class MildTrendShortI2hV11(TrendingStrategy):
    """EMA(20) < EMA(50) + RSI(14) < 45 + OBV < OBV_SMA(30)."""

    name = "mild_trend_short_I_2h_v11"
    horizon = "medium"
    direction = "short"
    ...
    def _raw_signal(self, bar_index: int) -> float:
        ...
        signal = -(0.25 + min(0.2, spread * 6.0))
