"""MildTrendShortI2hV17 — Vortex bearish + CCI oversold.

Economic logic: Vortex(18) VI- > VI+ on 2H Iron Ore identifies bearish
rotational momentum. CCI(18) < -50 confirms the instrument is trading below
its statistical mean with bearish momentum, validating the short bias.
"""
...
class MildTrendShortI2hV17(TrendingStrategy):
    """Vortex(18) VI- > VI+ + CCI(18) < -50."""

    name = "mild_trend_short_I_2h_v17"
    horizon = "medium"
    direction = "short"
