"""MildTrendShortI2hV12 — SuperTrend bearish + CMF distribution.

Economic logic: SuperTrend(12,3.0) flipping bearish on 2H Iron Ore signals
a regime shift to downtrend. CMF(18) < 0 confirms institutional distribution,
...
class MildTrendShortI2hV12(TrendingStrategy):
    """SuperTrend(12,3.0) bearish + CMF(18) < 0."""

    name = "mild_trend_short_I_2h_v12"
    horizon = "medium"
    direction = "short"
