"""TSMOM Medium Baseline — 3-month Time Series Momentum.

# NOTE: See AlphaForge CLAUDE.md for BacktestContext API, BacktestConfig, etc.

Economic logic: Intermediate-term momentum captures the herding phase of
price trends.  3-month lookback is the classical TSMOM horizon in academic
literature (Moskowitz, Ooi, Pedersen 2012).
"""
...
class TSMOMMedium(TrendingStrategy):
    """3-month TSMOM Baseline (Medium Horizon).

    Signal: past 60 bars cumulative return > 0  ->  +1, else -1.
